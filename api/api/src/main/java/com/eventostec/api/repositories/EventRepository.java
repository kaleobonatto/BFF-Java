...
public interface EventRepository extends JpaRepository<Event, UUID> {
    ...
    Page<EventProjection> findFilteredEvents(@Param("city") String city,
                                    @Param("uf") String uf,
    ...
    public Page<EventProjection> findUpcomingEvents(@Param("currentDate") Date currentDate, Pageable pageable);
